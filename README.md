...
Screen 0.0.0 (Screen000) — Menu Principal

1. Clientes - cadastro básico
2. Produtos - cadastro básico
3. Pedidos — criar, listar e editar pedidos
4. Relatórios — relatórios básicos
5. Sair

Screen 1.0.0 (Screen100) — Clientes

1. criar novo usuário
2. listar usuários
3. Voltar

Screen 2.0.0 (Screen200) — Produtos

1. criar novo produto
2. listar produtos
3. Voltar

Screen 3.0.0 (Screen300) — Pedidos

1. criar pedido
2. listar pedidos
3. Voltar

Screen 4.0.0 (Screen300) — Relatórios
